...
public class TableTest extends WebTest {
    ...
    public void can_find_table_by_id() {
        ...
        try {
            ...
            assertThat(e.getMessage(), is("Cannot find component defined by jQueryExpression=$('#table_0')"));
        }
    }
    ...
    public void can_obtain_caption() {
        ...
        assertThat(table.caption(), has(title("caption5_title")));
    }
    ...
    public void can_obtain_colgroups() {
        ...
        assertThat(table.colgroups(), has(size(2)));
    ...
    public void can_obtain_cols() {
        ...
        assertThat(table.cols(), has(size(4)));
        assertThat(table.cols().get(0), has(title("col_0")));
        assertThat(table.cols().get(1), has(title("col_1")));
        assertThat(table.cols().get(2), has(title("col_2")));
        assertThat(table.cols().get(3), has(title("col_3")));
    }
    ...
    public void can_obtain_table_rows() {
        ...
        assertThat(table.tr(), has(size(1)));

        table = component(Table.class, $("#table_4"));
        assertThat(table.tr(), has(size(4)));

        table = component(Table.class, $("#table_6"));
        assertThat(table.tr(), has(size(8)));
    }
    ...
    public void can_find_caption_by_id() {
        ...
        try {
            ...
            assertThat(e.getMessage(), is("Cannot find component defined by jQueryExpression=$('#caption_ess0')"));
        }
    }
    ...
    public void can_find_thead_by_id() {
        ...
        try {
            ...
            assertThat(e.getMessage(), is("Cannot find component defined by jQueryExpression=$('#thead_ess0')"));
        }
    }
    ...
    public void can_find_tfoot_by_id() {
        ...
        try {
            ...
            assertThat(e.getMessage(), is("Cannot find component defined by jQueryExpression=$('#tfoot_ess0')"));
        }
    }
    ...
    public void can_obtain_tfoot_tr() {
        ...
        assertThat(tfoot.tr(), has(size(1)));
    ...
    public void can_find_tbody_by_id() {
        ...
        try {
            ...
            assertThat(e.getMessage(), is("Cannot find component defined by jQueryExpression=$('#tbody_ess0')"));
        }
    }
    ...
    public void can_obtain_tbody_tr() {
        ...
        assertThat(tbody.tr(), has(size(5)));
    }
    ...
    public void can_find_colgroup_by_id() {
        ...
        try {
            ...
            assertThat(e.getMessage(), is("Cannot find component defined by jQueryExpression=$('#colgroup_ess0')"));
        }
    }
    ...
    public void can_obtain_cols_associated() {
        ...
        assertThat(colgroup.cols(), has(size(3)));
        assertThat(colgroup.cols().get(0), has(title("col_1")));
        assertThat(colgroup.cols().get(1), has(title("col_2")));
        assertThat(colgroup.cols().get(2), has(title("col_3")));
    ...
    public void can_find_col_by_id() {
        ...
        try {
            ...
            assertThat(e.getMessage(), is("Cannot find component defined by jQueryExpression=$('#col_ess0')"));
        }
    }
    ...
    public void can_find_tr_by_id() {
        ...
        try {
            ...
            assertThat(e.getMessage(), is("Cannot find component defined by jQueryExpression=$('#tr_ess0')"));
        }
    }
    ...
    public void can_find_th_by_id() {
        ...
        try {
            ...
            assertThat(e.getMessage(), is("Cannot find component defined by jQueryExpression=$('#th_ess0')"));
        }
    }
    ...
    public void can_find_td_by_id() {
        ...
        try {
            ...
            assertThat(e.getMessage(), is("Cannot find component defined by jQueryExpression=$('#td_ess0')"));
        }
    }
