...
import static org.testatoo.cartridge.html4.element.HtmlElementType.Radio;
...
public final class Radio extends org.testatoo.core.component.Radio implements Coreattrs, I18n {
     ...
     * @throws ComponentException if the given id does not correspond to a "input" element with type="radio"
     */
    public Radio(HtmlEvaluator evaluator, String id) {
        super(evaluator, id);
        ...
        if (evaluator.htmlElementType(id) != Radio) {
            throw new ComponentException("The component with id=" + id + " is not a " + Radio + " but a " + evaluator.htmlElementType(id));
        }
    }
     ...
     *
     * @return the radio type of the "input" element
     ...
     *
     * @return the alt of the radio button
     ...
     *
     * @return the tabindex of the radio button
     ...
     * Accesskey can be used to associate a particular keyboard shortcut to the radio button.
     *
     * @return the accesskey of the radio button
